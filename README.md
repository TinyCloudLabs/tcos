...
TinyCloud projects adopting this policy should use the SPDX identifier:
...
Apache-2.0 does not grant permission to use TinyCloud names, logos, or marks to
claim endorsement, certification, or official status. TinyCloud trademark and
certification policies are maintained separately from the copyright license.
